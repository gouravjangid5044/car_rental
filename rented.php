...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Rento - Car : Rented Cars</title>
    <link
    ...
    >
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <div class="container">
          ...
          <?php
          $str=$_SESSION['mail'];
          $query="SELECT * FROM `details` WHERE mail='$str' and status='Rented'";
          ...
          if($rows!=0)
          {
              ...
              <div class="featured-car-card">
                ...
                <div class="card-content">
                  ...
                  <ul class="card-list">
                    ...
                    <p class="card-price">
                      <strong>₹
                        <span style="display:inline;" class="charges"><?php
                        $car_id=$row['id'];
                        $query4="SELECT * FROM `rented` WHERE car='$car_id'";
            ...
            else
            {
              ...
              class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"
            >
              Nobody Has Rented Car From You❗
            </h2>';
            }
          ?>
          </ul>
